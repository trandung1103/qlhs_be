...
import { getHealthInsuranceStatus } from '../common/utils/health-insurance-status';
...
export const STUDENT_EXPORT_FIELDS: Record<
  string,
  { header: string; getValue: (student: StudentWithClass) => string | number }
> = {
  ...
  healthInsuranceStatus: {
    ...
    getValue: (s) => getHealthInsuranceStatus(s.hasHealthInsurance, s.healthInsuranceEndDate),
  },
